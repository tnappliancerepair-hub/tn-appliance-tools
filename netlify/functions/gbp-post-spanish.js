...
const POOL = [
  { id: 'quickcheck', url: SITE + '/es/', body: '¿Se te descompuso un electrodoméstico? 🔧 Te ayudamos — atención en español. Con la Revisión Rápida de $50 envías un video corto y una foto del número de modelo, y un técnico de verdad te dice qué está mal y tus opciones. Los $50 se acreditan a tu reparación. Llámanos o escríbenos: 1-888-268-8998.' },
  { id: 'diy', url: SITE + '/es/fix/', body: '¿Prefieres arreglarlo tú mismo? 💪 Tenemos guías honestas y gratis en español para los problemas más comunes — lavadora, secadora, refrigerador, lavavajillas, estufa y más. Te decimos qué revisar con seguridad y si vale la pena repararlo. Y si necesitas un técnico, aquí estamos. 1-888-268-8998.' },
  { id: 'dryer-fire', url: SITE + '/es/fix/dryer-not-heating.html', body: '🔥 ¿Tu secadora tarda dos o tres ciclos en secar? Casi siempre es el ducto tapado — y también es la causa #1 de incendios de secadora. Limpiarlo hace que seque más rápido y previene un riesgo real. Te decimos cómo, o lo hacemos por ti. Escríbenos en español: 1-888-268-8998.' },
  { id: 'fridge', url: SITE + '/es/fix/refrigerator-not-cooling.html', body: '🧊 ¿Tu refrigerador funciona pero no enfría? Antes de pensar en lo peor: muchas veces son los serpentines sucios o un ventilador — un arreglo económico, no el compresor. Aspira los serpentines y mira si mejora. ¿Sigue tibio? Un técnico real te da una respuesta honesta. 1-888-268-8998.' },
  { id: 'washer-drain', url: SITE + '/es/fix/washer-wont-drain.html', body: '🌀 ¿Tu lavadora deja el agua adentro? Casi siempre es el filtro de la bomba tapado — a menudo un arreglo de 10 minutos. Desconéctala, abre el filtro abajo al frente y límpialo. Te mostramos cómo, o lo resolvemos rápido. Atención en español: 1-888-268-8998.' },
  { id: 'ice', url: SITE + '/es/fix/no-hace-hielo.html', body: '❄️ ¿La fábrica de hielo dejó de hacer hielo? Lo más común: el filtro de agua vencido (cámbialo cada ~6 meses), una línea de agua doblada, o un congelador que no está a 0 °F. Son revisiones simples que puedes hacer hoy. ¿Necesitas ayuda? Escríbenos: 1-888-268-8998.' },
  { id: 'dishwasher', url: SITE + '/es/fix/lavavajillas-no-limpia.html', body: '🍽️ ¿El lavavajillas deja los platos sucios? Casi siempre es el filtro del fondo — límpialo una vez al mes y notarás la diferencia. También ayuda destapar los brazos aspersores y abrir el agua caliente antes de iniciar. Te lo explicamos en español, o lo revisamos por ti. 1-888-268-8998.' },
  { id: 'always-on', url: SITE + '/es/', body: '📱 ¿Se te dañó algo un domingo o a media noche? No hay problema — respondemos a cualquier hora. Escríbenos o llámanos cuando te quede bien y te contestamos rápido, en español. Reparación de electrodomésticos honesta, familia desde 2012. 1-888-268-8998.' },
  { id: 'honest', url: SITE + '/es/', body: '💬 Te decimos la verdad: no todo vale la pena repararlo. Con la Revisión Rápida de $50 un técnico real revisa tu video y te da la comparación honesta de reparar vs. reemplazar antes de que gastes de más. Sin sorpresas, en español. 1-888-268-8998.' },
  { id: 'gas-stove', url: SITE + '/es/fix/estufa-gas-no-enciende.html', body: '🔥 ¿El quemador de tu estufa de gas hace clic pero no prende? Muchas veces las piezas quedaron húmedas o mal puestas después de limpiar, o el encendedor está tapado. Te decimos qué es seguro revisar tú mismo — y qué dejar a un profesional. (Si hueles a gas, sal y llama a tu compañía de gas.) 1-888-268-8998.' },
  { id: 'washer-hoses', url: SITE + '/es/fix/lavadora-pierde-agua.html', body: '💧 Consejo que evita un desastre: revisa las mangueras de tu lavadora. Las de goma se agrietan con los años y son una causa común de inundaciones caseras — cámbialas cada 3 a 5 años. Nosotros las revisamos y reemplazamos. Atención en español: 1-888-268-8998.' },
  { id: 'microwave', url: SITE + '/es/fix/microondas-no-calienta.html', body: '📻 ¿Tu microondas enciende pero no calienta? ⚠️ Nunca lo abras tú mismo — guarda un voltaje peligroso aun desconectado. Pero sí puedes confirmar que no esté en modo temporizador y con la potencia al 100%. Si de verdad no calienta, es trabajo de técnico. Te ayudamos en español: 1-888-268-8998.' },
];
