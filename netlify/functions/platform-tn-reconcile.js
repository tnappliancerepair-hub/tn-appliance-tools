...
const MAX_PAGES = 6;          // 500/page — covers the whole active id range with room to spare
...
exports.handler = async function (event) {
  ...
  if (!base || !key || !xtok) return { statusCode: 200, headers: { 'content-type': 'application/json' }, body: JSON.stringify({ ok: false, error: 'not_configured', have: { supabase_url: !!base, supabase_key: !!key, xano_token: !!xtok } }) };
