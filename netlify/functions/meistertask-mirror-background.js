...
exports.handler = async function (event) {
  ...
  try {
    ...
    const report = {
      ...
      project: r.project, boards_pulled: r.boards_pulled, open_cards: r.open_cards, active_cards: r.active_cards, card_status_histogram: r.card_status_histogram, board_jobs: r.board_jobs,
      counts: r.counts, matched_via: r.matched_via, move_breakdown: r.move_breakdown, column_reconcile: r.column_reconcile,
