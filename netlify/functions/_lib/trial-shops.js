...
const SHOPS = {
  ...
  'greg': {
    ...
    platformSlug: '',                   // 2026-09-12: his platform tenant was purged (he was not using the board). Ann stays a pure lead-catcher: she answers + texts Greg. Re-provision the tenant and put the slug back to restore the board+portal bridge.
