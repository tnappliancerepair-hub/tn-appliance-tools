...
exports.handler = async function () {
  ...
  if (require('./_lib/office-gate').officeBlocked('+1' + TEDDY, 'sp_parts_check_reminder')) { return { statusCode: 200, body: JSON.stringify({ ok: true, sent: false, suppressed: true }) }; } // 🔇 office kill
  try {
