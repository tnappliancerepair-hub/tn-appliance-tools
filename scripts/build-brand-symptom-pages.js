...
const APPLIANCE_OF = { 'refrigerator-not-cooling': 'refrigerator', 'dryer-not-heating': 'dryer', 'washer-wont-drain': 'washer', 'dishwasher-wont-drain': 'dishwasher' };
const SYMPTOM_PHRASE = { 'refrigerator-not-cooling': 'not cooling', 'dryer-not-heating': "not heating", 'washer-wont-drain': "won't drain", 'dishwasher-wont-drain': "won't drain" };
