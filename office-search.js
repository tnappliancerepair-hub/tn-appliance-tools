...
(function () {
  ...
  // Inject bar at the top of <body>
  const bar = document.createElement('div');
  bar.className = 'ofc-search-bar';
  bar.innerHTML = `
    <input class="ofc-search-input" id="ofcSearch" placeholder="Search customer name, phone, or address…" autocomplete="off" inputmode="search">
