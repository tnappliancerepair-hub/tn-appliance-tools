      ...
      if ($cust_phone != "" && $sms_body != "") {
        api.request {
          ...
          params = {
            to         : $cust_phone
            message    : $sms_body
            context_tag: ("parts_event_" ~ $status_lower)
          }
      ...
      if ($status_lower == "ordered" && !$vendor_confirmed_flag) {
        ...
        api.request {
          ...
          params = {
            to         : "+16154850713"
            message    : $office_body
            context_tag: "manual_parts_order_needed"
          }
