  ...
  stack {
    ...
    conditional {
      if ($row_70065 != null) {
        ...
        var.update $actions {
          value = $actions
            |push:"70065 Kenner: reassigned to Andre (tech 3)"
        }
      }
    }
    ...
    conditional {
      if ($row_70126 == null) {
        ...
        var.update $actions {
          value = $actions
            |push:"70126 New Orleans East: ADDED to LA South (Andre)"
        }
      }
    }
    ...
    conditional {
      if ($row_70131 == null) {
        ...
        var.update $actions {
          value = $actions
            |push:"70131 Algiers: ADDED to LA South (Andre)"
        }
      }
    }
    ...
    conditional {
      if ($row_70461 == null) {
        ...
        var.update $actions {
          value = $actions
            |push:"70461 Slidell: ADDED to LA North (Billy)"
        }
      }
    }
    ...
    db.add event_log {
      data = {
        ...
        metadata: {dry_run: $is_dry, actions: $actions}
      }
    } as $log
  }

  response = {success: true, dry_run: $is_dry, actions: $actions}
