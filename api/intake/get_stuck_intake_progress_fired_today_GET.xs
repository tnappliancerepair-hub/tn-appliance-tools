// Daily dedup for the STUCK_INTAKE_PROGRESS_BATCH tick emit.
query get_stuck_intake_progress_fired_today verb=GET {
  api_group = "intake"
  ...
  guid = "get-stuck-intake-progress-fired-today-v1"
}
