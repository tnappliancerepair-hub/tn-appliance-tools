...
async function maybeEmitTimeSignals() {
  ...
  // (DAILY_HCP_COVERAGE_CHECK removed 2026-09-12 — TN is off Housecall Pro, so a daily
  // job comparing our schedule against theirs was auditing a system nobody uses.)
