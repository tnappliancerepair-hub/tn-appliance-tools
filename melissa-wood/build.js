...
// Generates ~100 pages from data templates with proper SEO + consistent layout.
...
const NEIGHBORHOODS = [
  { slug: 'tampa', name: 'Tampa', tag: 'The heart of Tampa Bay', features: ['Downtown waterfront', 'Riverwalk', 'Top employers', 'Major hospitals'] },
  { slug: 'south-tampa', name: 'South Tampa', tag: 'Old-money charm and walkable streets', features: ['Bayshore Boulevard', 'Hyde Park Village', 'Top-rated schools', 'Plant High School district'] },
  { slug: 'north-tampa', name: 'North Tampa', tag: 'Family neighborhoods with USF proximity', features: ['Close to USF', 'Busch Gardens nearby', 'New developments', 'Affordable single-family'] },
  { slug: 'new-tampa', name: 'New Tampa', tag: 'Master-planned communities and great schools', features: ['Tampa Palms', 'Hunters Green', 'Cross Creek', 'Top-ranked schools'] },
  { slug: 'brandon', name: 'Brandon', tag: 'Suburban Tampa with quick I-75 access', features: ['Brandon Mall', 'I-75 commute', 'Family-friendly', 'Great value per sq ft'] },
  { slug: 'valrico', name: 'Valrico', tag: 'Estate homes and gated communities', features: ['FishHawk-adjacent', 'Larger lots', 'A-rated schools', 'Established neighborhoods'] },
  { slug: 'wesley-chapel', name: 'Wesley Chapel', tag: 'One of Florida\'s fastest-growing communities', features: ['Wiregrass Mall', 'Florida Hospital', 'New construction', 'Excellent schools'] },
  { slug: 'ruskin', name: 'Ruskin', tag: 'Affordable waterfront living south of Tampa', features: ['Little Manatee River', 'Bay access', 'New developments', 'I-75 corridor'] },
  { slug: 'riverview', name: 'Riverview', tag: 'Family suburbs with strong value', features: ['Master-planned communities', 'Great schools', 'I-75 access', 'New construction'] },
  { slug: 'apollo-beach', name: 'Apollo Beach', tag: 'Tampa Bay\'s premier waterfront community', features: ['Deep water access', 'Manatee Viewing Center', 'Boating community', 'Luxury waterfront homes'] },
  { slug: 'fishhawk', name: 'FishHawk Ranch', tag: 'Award-winning master-planned community', features: ['Top-rated schools', 'Resort amenities', 'Family-focused', 'Multiple villages'] },
  { slug: 'bloomingdale', name: 'Bloomingdale', tag: 'Established Brandon-area neighborhood', features: ['Mature trees', 'Bloomingdale Golf Club', 'Family communities', 'Strong schools'] },
  { slug: 'carrollwood', name: 'Carrollwood', tag: 'Classic Tampa neighborhood with lake access', features: ['Lake Carroll', 'Original Carrollwood Village', 'Mature trees', 'Central location'] },
  { slug: 'westchase', name: 'Westchase', tag: 'Master-planned community on Tampa\'s west side', features: ['Top schools', 'Walkable village center', 'Country club', 'Family-friendly'] },
  { slug: 'lutz', name: 'Lutz', tag: 'Country living minutes from the city', features: ['Lake Park', 'Larger lots', 'A-rated schools', 'Close to Wesley Chapel + N. Tampa'] },
  { slug: 'land-o-lakes', name: 'Land O\' Lakes', tag: 'Wide-open space and waterfront homes', features: ['Lakes and ponds', 'Pasco County prices', 'Quick to N. Tampa', 'Growing community'] },
  { slug: 'plant-city', name: 'Plant City', tag: 'Charming small-town feel between Tampa and Lakeland', features: ['Strawberry Festival', 'Historic downtown', 'Affordable', 'I-4 access'] },
  { slug: 'sun-city-center', name: 'Sun City Center', tag: 'Florida\'s premier 55+ community', features: ['Golf courses', 'Active adult community', 'Maintenance-free living', 'Affordable retirement'] },
  { slug: 'davis-islands', name: 'Davis Islands', tag: 'Walkable island living in downtown Tampa', features: ['Tampa General Hospital', 'Walkable village', 'Boating community', 'Luxury homes'] },
  { slug: 'hyde-park', name: 'Hyde Park', tag: 'Tampa\'s most historic and walkable neighborhood', features: ['Hyde Park Village', 'Bayshore Boulevard', 'Historic homes', 'Walkable to downtown'] },
  { slug: 'soho', name: 'SoHo (South Howard)', tag: 'Trendy dining and nightlife district', features: ['Restaurants + bars', 'Walkable', 'Young professionals', 'New townhomes'] },
  { slug: 'channelside', name: 'Channelside', tag: 'Modern condos and downtown energy', features: ['Sparkman Wharf', 'Amalie Arena', 'Cruise terminal', 'New high-rises'] },
  { slug: 'seminole-heights', name: 'Seminole Heights', tag: 'Tampa\'s hippest historic neighborhood', features: ['Craft beer + dining', 'Bungalow homes', 'Young families', 'Revitalized'] },
  { slug: 'temple-terrace', name: 'Temple Terrace', tag: 'Established community with golf and river access', features: ['Hillsborough River', 'Golf course', 'USF nearby', 'Mature trees'] },
];
...
<script type="application/ld+json">
{
  ...
  "image": "https://${AGENT.domain}/melissa.jpg"
}
</script>
</head><body>`;
}
...
<a class="brand" href="/"><span class="brand-name">${AGENT.name}</span><span class="brand-sub">${AGENT.brokerage}</span></a>
<nav class="nav">
...
<div class="ft-bottom">© ${new Date().getFullYear()} ${AGENT.name} · ${AGENT.brokerage} · Licensed Real Estate Agent in Florida</div>
</div></footer>`;
}
...
<div class="cta-text">Ready to talk? Call or text Melissa directly.</div>
<div class="cta-buttons">
<a class="btn-primary" href="${AGENT.phoneHref}">📞 ${AGENT.phone}</a>
<a class="btn-secondary" href="${AGENT.emailHref}">✉ Email Melissa</a>
</div>
</div></section>`;
}
...
<h1>Buying or selling in Tampa Bay?<br><span class="hero-accent">Let's make it easy.</span></h1>
<p class="hero-lede">Melissa Wood helps Tampa Bay buyers and sellers from Brandon to Wesley Chapel, South Tampa to Ruskin. Honest advice, deep local knowledge, and full-service representation backed by ${AGENT.brokerage}.</p>
<div class="hero-cta">
<a class="btn-primary lg" href="${AGENT.phoneHref}">📞 Call Melissa: ${AGENT.phone}</a>
...
<div class="trust-item"><b>100-mile radius</b><span>Tampa · Brandon · Valrico · Wesley Chapel · Ruskin</span></div>
<div class="trust-item"><b>Full-service</b><span>Buyers + sellers + investors + relocations</span></div>
</div>
</div></section>

<section class="section"><div class="container">
<h2>Tampa Bay neighborhoods Melissa knows inside and out</h2>
<div class="grid-cards">
${NEIGHBORHOODS.slice(0, 12).map(n => `
<a class="card" href="/neighborhoods/${n.slug}.html">
<div class="card-title">${escapeHtml(n.name)}</div>
<div class="card-sub">${escapeHtml(n.tag)}</div>
</a>`).join('')}
</div>
...
<p class="section-lede">From your first home to your fifth, Melissa walks you through the process step by step. Local knowledge of every neighborhood, every school zone, every market trend that affects your decision.</p>
<div class="grid-cards">
...
<p class="section-lede">Pricing it right matters more than ever. Melissa's pre-listing prep, professional photography, and pricing strategy gets homes sold for the best terms — often above asking, even in shifting markets.</p>
<div class="grid-cards">
...
${leadForm('Get in touch with Melissa', 'Buying, selling, or just exploring — let\'s talk.')}
`;
  write('index.html', wrap({ title: 'Tampa Bay Real Estate', desc: `${AGENT.name} is a Tampa Bay Realtor helping buyers and sellers from Brandon to Wesley Chapel, South Tampa to Ruskin. Honest advice + deep local knowledge. Call ${AGENT.phone}.`, path: '' }, html));
}
...
<h2>Whether you're buying or selling, I'll be honest with you</h2>
<p>I'll tell you when a house is overpriced. I'll tell you when you should walk away. I'll tell you when a counter-offer is too aggressive. I'll tell you when your list price is wrong. That's the job — and it's what builds the long-term client relationships that drive my business.</p>
...
${leadForm('Want to chat?', 'Send your info and I\'ll call you back personally.')}
`;
...
${leadForm('Ready to start your search?', 'Tell Melissa what you\'re looking for and she\'ll send you matching listings.')}
`;
...
${leadForm('Get a free home valuation', 'Melissa will pull recent comps and send you a realistic price range — no obligation.')}
`;
...
<section class="section narrow"><div class="container">
<div class="callout">
<b>MLS search coming soon.</b> Until the IDX feed is live, send Melissa your search criteria — neighborhoods, price range, beds/baths, must-haves — and she'll set up a custom search that emails you matching listings the moment they hit the market.
</div>
<div class="cta-buttons" style="margin-top:24px;justify-content:flex-start">
<a class="btn-primary" href="${AGENT.phoneHref}">📞 Call: ${AGENT.phone}</a>
<a class="btn-secondary" href="${AGENT.emailHref}">✉ Email Search Criteria</a>
</div>
</div></section>
${leadForm('Build your custom Tampa Bay home search', 'Melissa will set you up with personalized email alerts for matching listings.')}
`;
...
<p class="page-lede">Call, text, or email — Melissa responds personally.</p>
</div></section>
<section class="section narrow"><div class="container">
...
<input type="tel" name="phone" placeholder="Phone">
<input type="email" name="email" placeholder="Email" required>
<textarea name="message" placeholder="Tell Melissa what you're looking for..." rows="5"></textarea>
<button type="submit">Send to Melissa</button>
</form>
</div>
</div>
</div></section>
`;
  write('contact.html', wrap({ title: 'Contact Melissa Wood', desc: `Reach Tampa Bay Realtor ${AGENT.name} directly. Call ${AGENT.phone} or email ${AGENT.email}.`, path: 'contact.html' }, html));
}
...
<p class="page-lede">All ${NEIGHBORHOODS.length} neighborhoods Melissa actively serves — deep guides for each.</p>
</div></section>
<section class="section"><div class="container">
<div class="grid-cards">
${NEIGHBORHOODS.map(n => `
...
${leadForm('Not sure which neighborhood is right?', 'Melissa will help you match neighborhoods to your lifestyle, commute, and budget.')}
`;
...
<p>${escapeHtml(n.name)} is one of Tampa Bay's distinctive neighborhoods. Whether you're buying your first home here, moving up, or looking for an investment property, Melissa Wood knows ${escapeHtml(n.name)} street by street and street by street — which subdivisions hold value, which streets flood, which builders deliver, which HOAs are reasonable.</p>
...
<p>When you're shopping in ${escapeHtml(n.name)}, you want a Realtor who has actually walked the streets, sat at the closings, and knows which homes have hidden issues. Melissa has helped buyers in ${escapeHtml(n.name)} navigate everything from new construction punch lists to negotiating inspection responses on older homes. Call her at <a href="${AGENT.phoneHref}"><b>${AGENT.phone}</b></a> to talk about your search.</p>

<h2>Selling in ${escapeHtml(n.name)}</h2>
<p>Pricing in ${escapeHtml(n.name)} requires neighborhood-level knowledge. Comps from a mile away can lead you astray. Melissa pulls true-comparable listings, walks your property in person, and gives you a realistic price range — not the optimistic number some agents use to win the listing. Get a real ${escapeHtml(n.name)} home valuation by calling <a href="${AGENT.phoneHref}"><b>${AGENT.phone}</b></a>.</p>

<h2>Schools, commutes, and lifestyle</h2>
<p>School zones, commute times, grocery options, parks, walkability — these are the things that determine whether ${escapeHtml(n.name)} is the right neighborhood for YOU specifically. Melissa will tell you straight up whether ${escapeHtml(n.name)} fits your situation or whether a nearby neighborhood would serve you better.</p>

<h2>Talk to a real ${escapeHtml(n.name)} Realtor</h2>
<p>Don't trust your home purchase or sale to a Zillow lead-gen agent who lives 20 miles away. Call Melissa directly at <a href="${AGENT.phoneHref}"><b>${AGENT.phone}</b></a> or email <a href="${AGENT.emailHref}">${AGENT.email}</a>.</p>
</div></section>
${leadForm(`Interested in ${n.name}?`, 'Melissa will share off-market opportunities, accurate comps, and her honest take on the neighborhood.')}
`;
...
function guidePage(g, type) {
  ...
  const html = `
<section class="page-hero"><div class="container">
<div class="breadcrumb"><a href="/${type === 'buyer' ? 'buy' : 'sell'}.html">All ${type === 'buyer' ? 'Buyer' : 'Seller'} Guides</a> · ${escapeHtml(g.title)}</div>
...
<h2>Next step</h2>
<p>The best first move is a quick phone call. Tell Melissa your situation, your timeline, and what's most important to you. She'll tell you honestly whether the timing makes sense and what realistic next steps look like. Call <a href="${AGENT.phoneHref}"><b>${AGENT.phone}</b></a> or email <a href="${AGENT.emailHref}">${AGENT.email}</a>.</p>
</div></section>
${leadForm(`Questions about ${g.intent.toLowerCase()}?`, 'Melissa will give you a straight answer + a clear next step.')}
`;
...
<p class="page-lede">Calculators, directories, and tools Melissa's clients use.</p>
</div></section>
<section class="section"><div class="container">
<div class="grid-cards">
${RESOURCES.map(r => `
...
<h2 style="margin-top:48px">Process pages</h2>
<div class="grid-cards">
${PROCESS_PAGES.map(p => `
...
<h2 style="margin-top:48px">Community + lifestyle</h2>
<div class="grid-cards">
...
function resourcePage(r) {
  const html = `
<section class="page-hero"><div class="container">
<div class="breadcrumb"><a href="/resources.html">Resources</a> · ${escapeHtml(r.title)}</div>
<h1>${escapeHtml(r.title)}</h1>
<p class="page-lede">${escapeHtml(r.desc || '')}</p>
</div></section>
<section class="section narrow"><div class="container">
<div class="callout">
<b>Talk to Melissa.</b> For a personalized version of this resource based on your specific situation, neighborhood, and budget — call <a href="${AGENT.phoneHref}"><b>${AGENT.phone}</b></a> or email <a href="${AGENT.emailHref}">${AGENT.email}</a>. Free, no obligation, no spam.
</div>
...
<h2>How to use it</h2>
<p>Walk through the questions or fields with realistic numbers. The output gives you a starting point, not a final answer. Bring the result to your conversation with Melissa, who'll refine it based on your specific neighborhood, property, and goals.</p>

<h2>Next step</h2>
<p>When you're ready to talk through your specific situation with a local Tampa Bay Realtor who'll tell you the truth, call Melissa Wood at <a href="${AGENT.phoneHref}"><b>${AGENT.phone}</b></a>.</p>
</div></section>
${leadForm('Get personalized numbers', `Send Melissa your situation and she'll come back with realistic local estimates.`)}
`;
...
<p class="page-lede">The questions Melissa hears most often, answered honestly.</p>
</div></section>
<section class="section"><div class="container">
<div class="grid-cards">
${FAQS.map(f => `
...
<h2>What Melissa recommends</h2>
<p>The best move is a 10-minute phone call. Tell Melissa your specific situation — your timeline, your budget, your goals — and she'll give you the realistic answer for YOUR scenario. Call <a href="${AGENT.phoneHref}"><b>${AGENT.phone}</b></a> or email <a href="${AGENT.emailHref}">${AGENT.email}</a>.</p>
...
${leadForm('Have a question?', 'Ask Melissa directly — no obligation, no high-pressure sales.')}
`;
...
<p>Melissa publishes Tampa Bay market reports based on local MLS data, not national headlines. National real estate news often misses what's actually happening in YOUR neighborhood — South Tampa moves differently than Wesley Chapel, Apollo Beach behaves differently than Brandon.</p>

<h2>The trends Melissa is watching</h2>
...
<p>Call Melissa at <a href="${AGENT.phoneHref}"><b>${AGENT.phone}</b></a> or email <a href="${AGENT.emailHref}">${AGENT.email}</a>. She'll send you a custom market snapshot for the exact neighborhood and price range you care about — usually within 24 hours.</p>
</div></section>
${leadForm('Want a neighborhood-specific report?', `Tell Melissa your area and she'll send a custom Tampa Bay market snapshot.`)}
`;
...
${leadForm('Want a custom market report?', `Melissa will send a neighborhood-specific snapshot for your area.`)}
`;
...
<section class="section narrow"><div class="container">
<p>Melissa Wood — Tampa Bay Realtor with ${AGENT.brokerage} — helps clients across the Tampa Bay region with everything from first homes to investment properties to relocations.</p>
<h2>How this applies to YOUR situation</h2>
<p>Every client is different. The general guidance here is a starting point — the right next step is a 10-minute conversation about your specific situation. Call Melissa at <a href="${AGENT.phoneHref}"><b>${AGENT.phone}</b></a> or email <a href="${AGENT.emailHref}">${AGENT.email}</a>.</p>
<h2>Why work with Melissa</h2>
...
${leadForm('Talk to Melissa', `Get personalized Tampa Bay real estate advice. Free, no obligation.`)}
`;
