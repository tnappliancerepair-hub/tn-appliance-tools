...
2. **Stand up applianceant.com on Netlify** (new site, Ant consumer brand) → point GoDaddy DNS.
3. **Move the ~200 nationwide/DIY pages** over + build the parts/Amazon-link layer + cross-links.
