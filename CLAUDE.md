...
- **OPEN — add-on sales tax = "tax added"** (Teddy decided): customer pays add-on price + tax at checkout. Needs wiring into add-on Stripe checkout (regional TN/LA rate) + Money→Tax view. NOT built — fresh-start item.
