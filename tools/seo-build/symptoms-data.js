...
module.exports = [
  ...
  // ===== REFRIGERATOR =====
  {
    ...
    isItWorthFixing: "Frost, fan, damper, and coil issues — yes every time, $200–$450 range. Sealed system repairs (compressor, refrigerant) start at $200 and climb depending on the system and parts. On older units (10+ years) some sealed system failures are still the call where replacement may win — we give you both numbers honestly, no pressure either way.",
    ...
    faqs: [
      ...
      { q: "Is it worth fixing a refrigerator that won't cool?", a: "Usually yes — most causes are non-sealed-system repairs in the $200–$450 range. Sealed system repairs (compressor, refrigerant) start at $200 and climb depending on the system, parts, and access. The TDR gives you the real number for your specific machine before any work starts." },
