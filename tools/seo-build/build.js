...
function buildAntPage() {
  ...
  const faqs = [
    ...
    { q: "Who built Appliance Ant?", a: "Appliance Ant is built by TN Appliance Exchange — Teddy and Danielle Pivacek, a family-owned business in Tennessee. Six technicians across Middle Tennessee and Louisiana use Ant to triage customer requests and deliver Technician Decision Reports." },
...
<p class="prose"><strong>Teddy and Danielle Pivacek built Appliance Ant to fix that.</strong> Teddy is the lead technician — fifteen years of appliance work in Tennessee, every brand, every failure mode. Danielle runs operations. Together they realized the bottleneck wasn't fixing appliances. It was the friction between a customer with a broken machine and a technician who could honestly tell them what to do about it.</p>
